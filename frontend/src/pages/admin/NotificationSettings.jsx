...
const EVENT_TYPES = [
  ...
  {
    key: "invoice.created",
    labelKey: "invoiceCreated",
    icon: Bell,
    defaultSound: "payment",
  },
  {
    key: "shipment.stalled",
    labelKey: "shipmentStalled",
    icon: Warning,
    defaultSound: "shipment",
  },
  {
    key: "shipment.no_tracking",
    labelKey: "shipmentNoTracking",
    icon: Warning,
    defaultSound: "shipment",
  },
  {
  ...
  {
    key: "contract.signed",
    labelKey: "contractSigned",
    icon: CheckCircle,
    defaultSound: "success",
  },
  {
    key: "staff.session_suspicious",
    labelKey: "suspiciousSession",
    icon: Lightning,
    defaultSound: "alert",
  },
  {
    key: "manager.inactive",
    labelKey: "managerInactive",
    icon: Warning,
    defaultSound: "alert",
  },
  {
    key: "deal.status_changed",
    labelKey: "dealStatusChanged",
    icon: Bell,
    defaultSound: null,
  },
];
...
const SeverityBadge = ({ severity }) => {
  ...
  return (
    <span
      className={`${c.bg} ${c.text} px-2 py-0.5 rounded-full text-xs font-medium`}
    >
      {c.label}
    </span>
  );
...
export default function NotificationSettings() {
  ...
  const updateRule = async (eventType, updates) => {
    ...
    try {
      ...
      setRules((prev) =>
        prev.map((r) => (r.eventType === eventType ? { ...r, ...updates } : r)),
      );
              ...
              {rule.channels.sound && (
                <div className="mt-4 pt-4 border-t border-zinc-100">
                  ...
                  <WhiteSelect
                    ...
                    onChange={(e) =>
                      updateRule(rule.eventType, { soundKey: e.target.value })
                    }
                  >
