...
const Field = ({ label, hint, error, children }) => (
  <div>
    ...
    {children}
    {hint && (
      <p className="text-[11.5px] text-[#71717A] mt-1 leading-snug">{hint}</p>
    )}
...
export default function AuthSettingsPage({ embedded = false }) {
  ...
  return (
    <div
      className={embedded ? "" : "p-6 max-w-5xl mx-auto"}
      data-testid="auth-settings-page"
    >
      {!embedded && (
        <div className="mb-6">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-[14px] font-semibold text-[#18181B] leading-tight truncate">
            {t("adm2_fallback_c34694fc28") ||
              "Currently effective (with fallback)"}
          </h2>
        </div>
      ...
      <div className="space-y-4">
        ...
        <Block
          ...
          onSave={() =>
            patch(
              { baseUrl: urls.baseUrl, frontendUrl: urls.frontendUrl },
              "urls",
            )
          }
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <Input
                ...
                onChange={(e) =>
                  setUrls({ ...urls, frontendUrl: e.target.value })
                }
                placeholder="https://bibicars.bg"
        ...
        <Block
          ...
          description={t(
            "adm_google_identity_services_popup_id_token_verificati",
          )}
        ...
        >
          ...
          >
            <Input
              ...
              onChange={(e) =>
                setGoogle({ ...google, allowedDomains: e.target.value })
              }
        ...
        <Block
          ...
          description={t(
            "adm_emailpassword_registration_settings_and_password_r",
          )}
            ...
            patch(
              {
                password: {
                  ...
                  resetTokenTtlMinutes:
                    Number(password.resetTokenTtlMinutes) || 60,
                },
              },
              "password",
            )
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Field
              label={t("adm_min_password_length") || "Min password length"}
              hint={t("adm_applies_to_register_and_reset")}
            >
              <Input
                type="number"
                min={4}
            ...
            <Field
              label={
                t("adm2_ttl_reset_ad4f34ff62") || "Reset link TTL (minutes)"
              }
              hint={t("adm_how_long_is_the_link_valid")}
            >
              <Input
                type="number"
                min={1}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-1">
            {[
              ...
              [
                ...
                t("adm2_38ff59c865") || "Password reset",
              ],
            ].map(([key, label]) => (
              <div
                key={key}
        ...
        >
          ...
          >
            <div className="flex gap-2">
              <Input
                ...
                placeholder={
                  doc?.jwt?.secretIsSet ? "********" : "super-secret-string"
                }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Field
              label={t("accessTokenTtl") || "Access TTL"}
              hint={t("adm_go_duration_format_15m_1h_24h")}
            >
              <Input
                value={jwt.accessExpires}
                onChange={(e) =>
                  setJwt({ ...jwt, accessExpires: e.target.value })
                }
            ...
            <Field label={t("refreshTokenTtl") || "Refresh TTL"}>
              <Input
                ...
                onChange={(e) =>
                  setJwt({ ...jwt, refreshExpires: e.target.value })
                }
          ...
          <Field label={t("adm_mode") || "Mode"}>
            ...
            >
              <option value="dry_run">
                {t("adm2_dry_run_b66359ea15") || "dry-run (log only)"}
              </option>
              <option value="smtp" disabled>
                {t("adm3_4733065469") || "SMTP (not configured)"}
              </option>
              <option value="resend" disabled>
                {t("adm3_77e3eecbd2") || "Resend (not configured)"}
              </option>
            </WhiteSelect>
          </Field>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Field label={t("fromLabel") || "From"}>
              <Input
                ...
                placeholder={
                  t("adm_noreplybibicarsbg") || "no-reply@bibicars.bg"
                }
            ...
            <Field label={t("replyTo") || "Reply-to"}>
              <Input
                ...
                placeholder={
                  t("adm_supportbibicarsbg") || "support@bibicars.bg"
                }
        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-1">
              Client ID / Client Secret для Google OAuth. Тестируйте через Test
              Connection.
            </p>
          </div>
        </div>
