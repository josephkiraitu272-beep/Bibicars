                ...
                <div key={idx} className="px-5 py-3 hover:bg-[#FAFAFA] transition-colors">
                  <div className="flex items-center justify-between mb-1">
                    {(invoice.customerId || invoice.customer?.id) ? (
                      <Link
                        to={`/admin/customers/${invoice.customerId || invoice.customer?.id}/360`}
                        className="text-sm font-medium text-[#18181B] hover:text-[#4F46E5] hover:underline"
                        data-testid={`tl-overdue-customer-link-${idx}`}
                      >
