  ...
  const loadStats = async () => {
    try {
      ...
      setStats({
        ...
        avg_duration:
          Math.round(
            calls.reduce((acc, c) => acc + (c.duration || 0), 0) / calls.length,
          ) || 0,
        conversion: 0,
      });
    } catch (error) {
    ...
    if (direction === "inbound")
      return (
        <PhoneIncoming
          ...
          data-testid="direction-inbound"
        />
      );
    return (
      <PhoneOutgoing
        className="h-4 w-4 text-blue-600"
        data-testid="direction-outbound"
      />
    );
  };
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <Card data-testid="stat-answered">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {t("adm3_e53b2f2d28")} {stats.calls_today}
            </p>
          </CardContent>
        </Card>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
          ...
          <div className="flex gap-2">
            ...
            <Select
              ...
              onValueChange={(v) =>
                setFilters({ ...filters, direction: v === "all" ? null : v })
              }
            >
              <SelectTrigger
                className="w-[150px]"
                        ...
                        <TableCell>
                          {call.lead ? (
                            <Button
                              ...
                              onClick={() =>
                                (window.location.href = `/admin/leads?id=${call.lead.id}`)
                              }
                        ...
                        <TableCell>
                          {call.deal ? (
                            <Button
                              ...
                              className="p-0 h-auto"
                              onClick={() =>
                                (window.location.href = `/admin/deals?id=${call.deal.id}`)
                              }
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <div className="font-mono font-medium">
                        {selectedCall.call_id || selectedCall._id}
                      </div>
                    </div>
                    <div>
                      <div className="text-muted-foreground">
                  ...
                  <CardContent>
                    <div className="space-y-1">
                      ...
                      <Button
                        ...
                        className="mt-2"
                        onClick={() =>
                          (window.location.href = `/admin/leads?id=${selectedCall.lead.id}`)
                        }
                      >
                        {t("openLead")}
                      </Button>
