...
export default function TeamOrdersPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const r = await axios.get(
        `${API_URL}/api/team/orders?${params.toString()}`,
      );
  ...
  const managers = Array.from(
    new Set(items.map((o) => o.managerEmail).filter(Boolean)),
  );
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-row items-start justify-between gap-3 sm:gap-4 mb-6">
        <div className="flex items-start gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs sm:text-sm text-[#71717A] mt-1 break-words">
              {t("teamOrdersDesc") || t("adm3_eea47d4d37")}
            </p>
          </div>
        </div>
        <div className="shrink-0 self-start">
          <RefreshButton
            onClick={load}
            loading={loading}
            ariaLabel={t("refreshAction")}
            testId="team-orders-refresh-btn"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        {[
          ...
          {
            label: t("inWork") || t("adm3_5e747bfe62"),
          ...
          {
            label: t("activeAmountSum") || t("adm3_59bf0d02e8"),
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-4 mb-4 flex flex-wrap items-center gap-2">
        ...
        >
          ...
          <option value="pending">
            {t("pending") || t("adm3_8c90679504")}
          </option>
          <option value="in_progress">
            {t("inWork") || t("adm3_5e747bfe62")}
          </option>
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50 text-xs uppercase text-gray-500">
            <tr>
              ...
              <th className="text-left px-5 py-3 font-medium">
                {t("services") || t("adm3_4e1a0e95e6")}
              </th>
              <th className="text-left px-5 py-3 font-medium">
                {t("progress") || t("adm3_7274b0d653")}
              </th>
