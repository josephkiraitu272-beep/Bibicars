...
const STR = {
  uk: {
    title: "Депозити",
    subtitle: "Усі ліди, які залишили депозит",
    search: "Пошук за іменем, телефоном…",
    all: "Усі",
    pending: "Очікує",
    paid: "Сплачено",
    cancelled: "Скасовано",
    ...
    empty: "Депозитів не знайдено",
    loading: "Завантаження…",
    total: "Усього депозитів",
    sumPaid: "Сплачено",
    sumPending: "Очікує",
    sumAmount: "Загальна сума",
    unassigned: "не призначено",
  },
  en: {
    title: "Deposits",
    subtitle: "All leads who left a deposit",
  ...
  bg: {
    title: "Депозити",
    subtitle: "Всички лийдове, оставили депозит",
    search: "Търсене по име, телефон…",
    all: "Всички",
    pending: "Изчаква",
    paid: "Платено",
    cancelled: "Отказано",
...
const Tile = ({ icon: Icon, label, value, color }) => (
  <div
    className="card bg-white p-4 flex items-center gap-3"
    data-testid="deposit-tile"
  >
    <div
    ...
    <div className="min-w-0">
      <p className="text-[11px] uppercase tracking-wider text-[#A1A1AA] truncate">
        {label}
      </p>
...
const LeadDeposits = () => {
  ...
  return (
    <motion.div
      data-testid="lead-deposits-page"
    ...
    >
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-[12.5px] font-medium border transition-colors ${
                  active
                    ...
                    : "bg-white text-[#3F3F46] border-[#E4E4E7] hover:border-[#A1A1AA]"
                }`}
              >
                {label}
              </button>
      ...
      <div
        ...
        data-testid="lead-deposits-table"
      >
          ...
          <table className="table-premium min-w-[760px] w-full">
            ...
            <tbody>
              {loading ? (
                ...
                filtered.map((d, idx) => {
                  const badge =
                    STATUS_BADGE[(d.status || "pending").toLowerCase()] ||
                    STATUS_BADGE.pending;
                  const openCard = () =>
                    d.customerId &&
                    navigate(`/admin/customers/${d.customerId}/360`);
                  return (
                    <tr
                      key={d.id || idx}
                      data-testid={`deposit-row-${d.id || idx}`}
                    ...
                    >
                      <td className="font-medium text-[#18181B]">
                        ...
                        {d.customerPhone ? (
                          <div className="text-[11px] text-[#A1A1AA] tabular-nums">
                            {d.customerPhone}
                          </div>
                        ) : null}
                      </td>
                      ...
                      <td className="text-xs text-[#3F3F46]">
                        {d.managerName || (
                      ...
                      <td className="text-right font-semibold text-[#16A34A] tabular-nums">
                      ...
                      <td className="text-xs text-[#71717A] tabular-nums">
