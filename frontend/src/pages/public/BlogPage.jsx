...
export default function BlogPage() {
  ...
  useSeo({
    title: "Blog — auto imports, customs, market insights | BIBI Cars",
    description:
      "Expert articles on importing cars to Bulgaria: customs duties, VIN checks, auction strategies, EV imports and market trends from US & Korean wholesale markets.",
    keywords:
      "car import blog, customs bulgaria blog, copart guide, encar guide, vehicle import tips",
    path: "/blog",
    alternates: {
      en: "/blog?lang=en",
      bg: "/blog?lang=bg",
    ...
    structuredData: {
      ...
      name: "BIBI Cars Blog",
      inLanguage: lang,
      publisher: { "@type": "Organization", name: "BIBI Cars" },
    },
  });
            ...
            <div className={styles.bracketWrap}>
              ...
              {tLocale === "bg" ? (
                <p className={styles.descText}>
                  <span className={styles.descFirst}>
                    Експертни анализи за купуване на коли от търгове в САЩ и
                    Корея.
                  </span>
                  <br />
                  Пазарни анализи, стъпка-по-стъпка ръководства и истински
                  <br />
                ...
                <p className={styles.descText}>
                  <span className={styles.descFirst}>
                    Expert insights on buying cars from USA &amp; Korean
                    auctions.
                  </span>
                  <br />
                  Market analytics, step-by-step guides and real import
                  <br />
            ...
            <div className={styles.featuredRow}>
              ...
              >
                <img
                  ...
                  src={
                    resolveImage(featuredMain.cover_image_url) ||
                    "/figma/blog/image-15@2x.png"
                  }
                  alt={featuredMain.title}
                  onError={(e) => {
                    e.target.src = "/figma/blog/image-15@2x.png";
                  }}
                />
                <div className={styles.featuredInfo}>
                  ...
                  <div className={styles.featuredBottom}>
                    <div className={styles.dateRow}>
                      <span>
                        {formatDate(featuredMain.published_at, tLocale)}
                      </span>
                      <span className={styles.dot}>•</span>
                      <span className={styles.minRead}>
                        {featuredMain.read_time_minutes}{" "}
                  ...
                  {visibleLatest.map((a) => (
                    ...
                    >
                      <img
                        ...
                        src={
                          resolveImage(a.cover_image_url) ||
