...
export default function BlogPage() {
  ...
  useSeo({
    ...
    description: 'Expert articles on importing cars to Bulgaria: customs duties, VIN checks, auction strategies, EV imports and market trends from US & Korean wholesale markets.',
    keywords:    'car import blog, customs bulgaria blog, copart guide, encar guide, vehicle import tips',
    path:        '/blog',
    alternates:  { en: '/blog?lang=en', bg: '/blog?lang=bg', 'x-default': '/blog' },
    structuredData: {
