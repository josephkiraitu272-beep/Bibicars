...
export default function VinCheckPage() {
  ...
  useSeo({
    ...
    description: 'Decode any 17-character VIN: make, model, year, engine, equipment, accident & odometer history snapshots — free, instant, no signup.',
    keywords:    'vin decoder, vin check bulgaria, vehicle history report, decode vin online',
    path:        vin ? `/vin-check/${vin}` : '/vin-check',
    alternates:  { en: '/vin-check?lang=en', bg: '/vin-check?lang=bg', 'x-default': '/vin-check' },
  });
