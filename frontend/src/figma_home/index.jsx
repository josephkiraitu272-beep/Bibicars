...
export default function FigmaHomePage() {
  useSeo({
    ...
    description: 'Live calculator, VIN check, customs handling and door-to-door delivery of vehicles from Copart, IAAI, Manheim and ENCAR auctions to Bulgaria. Transparent pricing, zero hidden fees.',
    keywords:    'car import bulgaria, used cars bulgaria, copart bulgaria, encar bulgaria, vehicle import calculator, vin check, авто от америка, авто от корея, внос на автомобили',
    path:        '/',
    alternates:  { en: '/?lang=en', bg: '/?lang=bg', 'x-default': '/' },
  });
