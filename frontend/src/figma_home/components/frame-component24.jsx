...
const FrameComponent24 = ({ className = "" }) => {
  ...
  const T = isBg
    ? {
        ...
        choose: "Правилен подбор на автомобил",
        ...
        find: "Ние ще ви помогнем да изберете автомобил, който да отговаря на стила и бюджета ви",
