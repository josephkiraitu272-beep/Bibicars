...
const SidebarTooltip = ({ path, lang, children }) => {
  ...
  return (
    <span className="relative block group">
      ...
      <span
        role="tooltip"
        className="absolute z-50 hidden ml-2 transition-opacity duration-150 -translate-y-1/2 opacity-0 pointer-events-none group-hover:pointer-events-auto left-full top-1/2 w-72 group-hover:opacity-100 lg:block"
...
const Layout = () => {
  ...
  useEffect(() => {
    ...
    const load = () => {
      fetch(`${API}/api/admin/identity/exceptions/count`, {
        ...
        .then((d) => {
          if (d && !cancelled) setAutomationExceptionsCount(d.pending || 0);
        })
        .catch(() => {});
    };
    load();
  ...
  const navGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        // Sales-style list.
        {
          path: "/admin/lead-deposits",
          icon: Wallet,
          labelKey: "crmDeposits_nav",
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          path: "/admin/invoice-reminders",
          icon: PhoneCall,
          labelKey: "invoiceReminders",
    ...
    },
    {
      ...
      items: [
        ...
        {
          path: "/admin/manager-instructions",
          icon: FileText,
          label: "Manager Instructions",
          roles: ["master_admin", "admin"],
        },
        {
          path: "/admin/manager-instructions/view",
          icon: FileText,
          label: "Manager Instructions",
    ...
    },
    {
      ...
      type: "single",
      item: {
        path: "/admin/insights?tab=traffic",
        icon: Heart,
        labelKey: "userEngagement",
      },
    ...
    },
    {
      ...
      type: "single",
      item: {
        path: "/manager/wishlist",
        icon: Fire,
        labelKey: "topDealsBuilder",
      },
    ...
    },
    {
      ...
      type: "single",
      item: {
        path: "/team/wishlist-approvals",
        icon: Lightning,
        labelKey: "topDealsApprovals",
      },
      roles: ["master_admin", "admin", "team_lead"],
    },
    {
      ...
      items: [
        {
          path: "/admin/payments",
          icon: CreditCard,
          label: t("i18n_payments_stripe_c21776"),
          roles: ["master_admin", "admin"],
        },
        {
          path: "/admin/services",
          icon: Stack,
          label: t("i18n_services_catalog_16a322"),
          roles: ["master_admin", "admin"],
        },
        {
          path: "/admin/settings/notifications",
          icon: Bell,
          label: t("hub_sidebar_label"),
          roles: ["master_admin", "admin"],
        },
        // Tracking-hub items moved to top-level `/admin/tracking` (see TrackingLayout.jsx)
        {
          path: "/admin/ringostat",
          icon: Phone,
          labelKey: "ringostat",
          roles: ["master_admin", "admin"],
        },
        ...
        },
        {
          path: "/admin/parser",
          icon: Database,
          label: t("i18n_vin_parser_4ae3fa"),
        },
        {
          path: "/admin/security",
          icon: Shield,
        ...
        },
        {
          ...
          icon: Globe,
          labelKey: "siteIntegrationsNav",
          roles: ["master_admin", "admin"],
        },
        {
          path: "/admin/seo-settings",
          icon: MagnifyingGlass,
          label: t("seoSettings") || "SEO & Analytics",
          roles: ["master_admin"],
        },
  ...
  const userHasRole = (requiredRoles) => {
    ...
    if (userRole === "admin" && requiredRoles.includes("master_admin"))
      return true;
  ...
  const SEARCH_ALIASES = {
    ...
    "/admin/manager-instructions/view": [
      "manager instructions",
      "instructions",
      "инструкции",
      "інструкції",
  ...
  const searchIndex = React.useMemo(() => {
    ...
    const addEntry = (path, label, keywords, groupLabel) => {
      ...
      out.push({
        ...
        keywords: [...new Set([...(keywords || []), lastSeg].filter(Boolean))],
      });
    };
    ...
    if (role === "team_lead") {
      [
        [
          "/team/dashboard",
          lbl("teamDashboard", "Team Dashboard"),
          [
            "dashboard",
            "team dashboard",
            "панель",
        ...
        [
          "/team/tasks",
          lbl("tasks", "Tasks"),
          [...(SEARCH_ALIASES.tasks || [])],
        ],
        [
          "/team/payments",
          "Payments",
          ["payments", "payment", "платежи", "оплата", "платіжі"],
        ],
        [
          "/team/shipping",
          "Shipping",
        ...
        [
          "/team/orders",
          "Orders",
          ["orders", "order", "заказы", "замовлення", "заявки"],
        ],
        [
          "/team/wishlist-approvals",
          lbl("topDealsApprovals", "Top Deals Approvals"),
          ["top deals", "approvals", "одобрения", "затвердження", "подборки"],
        ],
        [
          "/team/login-audit",
          "Login Audit",
          ["login audit", "audit", "аудит", "логи входа"],
        ],
        [
          "/team/carfax",
          lbl("adm_carfax", "CarFax"),
          [...(SEARCH_ALIASES.adm_carfax || [])],
        ],
        [
          "/team/profile/password",
          "Change Password",
          [
            "password",
            "change password",
    ...
    if (role === "manager") {
      [
        ...
        [
          "/manager/calls",
          "Calls",
          ["calls", "call", "звонки", "дзвінки", "телефония", "телефонія"],
        ],
        [
          "/manager/calls/missed",
          "Missed Calls",
          ["missed calls", "missed", "пропущенные", "пропущені"],
        ],
        [
          "/manager/tasks",
          lbl("tasks", "Tasks"),
        ...
        [
          "/manager/invoices",
          "Invoices",
          ["invoices", "invoice", "счета", "рахунки", "инвойсы"],
        ],
        [
          "/manager/orders",
          "Orders",
        ...
        [
          "/manager/tracking",
          "Tracking",
          ["tracking", "отслеживание", "відстеження", "трекинг"],
        ],
        [
          "/manager/engagement",
          lbl("userEngagement", "Engagement"),
          ["engagement", "traffic", "вовлеченность", "залученість"],
        ],
        [
          "/manager/wishlist",
          lbl("topDealsBuilder", "Top Deals Builder"),
          ["top deals", "wishlist", "подборки", "топ сделки", "топ пропозиції"],
        ],
        [
          "/manager/carfax",
          lbl("adm_carfax", "CarFax"),
    ...
    const push = (path, label, labelKey, groupLabel) => {
      ...
      out.push({
        ...
        group: groupLabel || null,
        keywords: [
          ...new Set([...aliasByKey, ...aliasByPath, lastSeg].filter(Boolean)),
        ],
      });
    };
    for (const g of visibleGroups) {
      ...
      if (g.type === "group" && Array.isArray(g.items)) {
        ...
        const firstVisible = g.items.find(
          (it) => !it.roles || userHasRole(it.roles),
        );
        if (firstVisible)
          push(`grp:${g.id}|${firstVisible.path}`, groupLbl, g.labelKey, null);
  ...
  const resolveSearchPath = (path) =>
    path && path.startsWith("grp:") ? path.split("|")[1] : path;
        ...
        if (Array.isArray(g.item.extraMatch)) {
          for (const alias of g.item.extraMatch) {
            out.push({
              path: g.item.path,
              alias,
              matchPrefix: !!g.item.matchPrefix,
            });
          }
        }
      }
  ...
  return (
    <div className="admin-layout flex h-screen bg-[#F7F7F8]">
      ...
      >
        ...
        {/* Navigation */}
        <nav
          className="flex-1 py-3 overflow-y-auto md:py-4"
          ...
          <NavLink
            to={
              (user?.role || "").toLowerCase() === "manager"
                ? "/manager/profile/password"
                : (user?.role || "").toLowerCase() === "team_lead"
                  ? "/team/profile/password"
        ...
        <header className="relative z-30 h-14 md:h-16 bg-white border-b border-[#E4E4E7] flex items-center justify-between px-3 sm:px-4 md:px-8 gap-2">
          ...
          <div className="flex items-center flex-1 min-w-0 gap-2 sm:gap-3">
            ...
            <div className="relative hidden md:block w-80">
              ...
              {searchQuery.trim() && (
                <div
                  className="absolute top-full left-0 right-0 mt-1 bg-white border border-[#E4E4E7] rounded-xl shadow-lg z-50 py-2 max-h-80 overflow-auto"
                  ...
                  {filteredSearchItems.length > 0 ? (
                    filteredSearchItems.map((item) => (
                      ...
                      >
                        ...
                        {item.group && (
                          <span className="text-[11px] text-[#A1A1AA] shrink-0 px-1.5 py-0.5 bg-[#F4F4F5] rounded">
                            {item.group}
                          </span>
                        )}
                      </button>
                    ...
                    <div
                      className="px-4 py-3 text-sm text-[#A1A1AA]"
          ...
          <div className="flex items-center flex-shrink-0 gap-1 sm:gap-2 md:gap-3">
            ...
            <div className="relative flex-shrink-0" ref={langDropdownRef}>
              ...
              >
                ...
                <span className="hidden sm:inline">
                  {(languages || LANGUAGES).find((l) => l.code === lang)?.label}
                </span>
                <CaretDown
                  size={14}
        ...
        <main className="flex-1 overflow-auto px-4 py-5 md:px-6 md:py-6 lg:px-[50px] lg:py-8">
          ...
          {isMobileSearchOpen && (
            <div className="relative mb-4 md:hidden">
              ...
              {searchQuery.trim() && (
                <div
                  className="absolute top-full left-0 right-0 mt-1 bg-white border border-[#E4E4E7] rounded-xl shadow-lg z-50 py-2 max-h-72 overflow-auto"
