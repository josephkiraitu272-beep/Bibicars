        ...
        <table className="table-premium min-w-[720px] w-full">
          ...
          <tbody>
            {loading ? (
              ...
              leads.map((lead) => {
                const mgr = lead.managerId
                  ? (managers || {})[lead.managerId]
                  : null;
                  ...
                  >
                    {canBulkActions ? (
                      <td className="w-10 text-center">
                        <input
                          ...
                          className="rounded border-[#A1A1AA] text-[#4F46E5]"
                          data-testid={`lead-table-select-${lead.id}`}
                        />
                      </td>
                    ) : null}
                    <td className="font-medium text-[#18181B]">
                      <div className="truncate max-w-[180px] flex items-center gap-1.5">
                        ...
                        <LeadSiteTemperatureBadge
                          lastSeen={(activityMap || {})[lead.id]}
                          size="xs"
                        />
                      </div>
                      {lead.email ? (
                    ...
                    <td>
                      {lead.phone ? (
                        <a
                          ...
                          className="inline-flex items-center gap-1 text-[#18181B] hover:text-[#4F46E5] tabular-nums"
                    ...
                    <td>
                      ...
                      >
                        <SelectTrigger
                          className="w-[140px] h-8 bg-transparent border-0 p-0"
                    ...
                    <td>
                      {mgr ? (
                        <div className="flex items-center gap-1.5 text-xs">
                          ...
                          <span className="text-[#18181B] truncate max-w-[110px]">
                            {mgr.name || mgr.email}
                          </span>
                        </div>
                      ) : (
                        <span className="text-xs text-[#A1A1AA] italic flex items-center gap-1">
                    ...
                    >
                      <div className="flex flex-col leading-tight">
                        ...
                        lead.statusChangedAt !== lead.lastContactAt ? (
                          <span
                      ...
                      <div className="flex items-center justify-end gap-1">
                        {onReassign ? (
                          <button
                            ...
                            className="p-2 hover:bg-[#EEF2FF] rounded-lg"
