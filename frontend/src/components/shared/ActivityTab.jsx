...
const T = {
  uk: {
    ...
    activity_subtitle:
      "Як цей клієнт поводиться у вашому веб-сайті — у режимі реального часу.",
    refresh: "Оновити",
    loading: "Завантаження…",
    no_data_title: "Поки немає активності",
    no_data_subtitle:
      "Як тільки клієнт зайде на сайт або заповнить форму — події з'являться тут.",
  ...
  en: {
    ...
    activity_subtitle:
      "How this customer behaves on your website — in real time.",
    refresh: "Refresh",
    loading: "Loading…",
    no_data_title: "No activity yet",
    no_data_subtitle:
      "Events will appear here as soon as the customer visits the site or fills a form.",
  ...
  bg: {
    ...
    activity_subtitle:
      "Как се държи този клиент във вашия уебсайт — в реално време.",
    refresh: "Обнови",
    loading: "Зарежда…",
    no_data_title: "Все още няма активност",
    no_data_subtitle:
      "Събитията ще се появят, щом клиентът посети сайта или попълни форма.",
...
const EVENT_META = {
  ...
  callback_request: {
    ...
    labelKey: "event_callback_request",
  },
  cabinet_login: {
    icon: SignIn,
    color: "text-sky-600",
...
const STATUS_META = {
  ...
  warm: {
    ...
    hintKey: "status_warm_hint",
    labelKey: "status_warm",
  },
  inactive: {
    icon: Snowflake,
    color: "text-rose-600",
    ...
    hintKey: "status_inactive_hint",
    labelKey: "status_inactive",
  },
};
...
const KpiCard = ({
  ...
  >
    ...
    <div className={`text-2xl font-bold ${accent} tabular-nums leading-none`}>
      {value}
    </div>
    {subValue ? (
      <div className="text-xs text-zinc-500 mt-1">{subValue}</div>
    ) : null}
    {hint ? <div className="text-[11px] text-zinc-400 mt-1">{hint}</div> : null}
  </div>
);
...
const TimelineEntry = ({ event, t, isFirst, isLast }) => {
  ...
  return (
    ...
    >
      {/* connector */}
      {!isLast && (
        <span className="absolute left-[1.05rem] top-9 bottom-0 w-px bg-zinc-200" />
      )}
      {/* dot */}
      <span
      ...
      <div className="pb-5">
        <div className="flex items-baseline justify-between gap-3 flex-wrap">
          ...
          <time
            className="text-xs text-zinc-400 tabular-nums shrink-0"
        ...
        {path && (
          <div className="mt-1 flex items-center gap-1.5 text-xs text-zinc-500">
            ...
            <span className="truncate" title={event.page_url}>
              {path}
            </span>
          </div>
        )}
        ...
        <>
          ...
          >
            <KpiCard
              ...
              subValue={
                kpi.last_visit_at
                  ? new Date(kpi.last_visit_at).toLocaleString()
                  : null
              }
            ...
            >
              ...
              <div>
                ...
                <p className="text-[11px] text-zinc-400 mt-2">
                  {t(STATUS_META[statusKey].hintKey)}
                </p>
              </div>
            </div>
            <KpiCard
