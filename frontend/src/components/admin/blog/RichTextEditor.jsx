    ...
    <div className={styles.wrap} data-testid={testId}>
      <div className={styles.toolbar}>
          ...
          onChange={(e) => {
            ...
            if (v === "p") editor.chain().focus().setParagraph().run();
              ...
              editor
                .chain()
                .focus()
                .toggleHeading({ level: parseInt(v[1], 10) })
                .run();
          }}
        ...
        <Btn
          ...
          title={t("subscriptLabel")}
          testId="rte-sub"
        >
          <span style={{ fontSize: 11, fontWeight: 600 }}>{t("cmp_x_2")}</span>
        </Btn>
        <Btn
          active={editor.isActive("superscript")}
          onClick={() => editor.chain().focus().toggleSuperscript().run()}
          title={t("superscriptLabel")}
          testId="rte-sup"
        >
          <span style={{ fontSize: 11, fontWeight: 600 }}>{t("cmp_x")}</span>
        </Btn>
        <Btn
        ...
        <div className={styles.colorWrap}>
          <Btn title={t("textColor")}>
            <PaintBrushHousehold size={16} />
          </Btn>
          <div className={styles.colorPop}>
            ...
            <button
              ...
              className={`${styles.colorSwatch} ${styles.colorClear}`}
              title={t("resetColor")}
            >
              ×
            </button>
        ...
        />
        <Btn onClick={insertYoutube} title={t("embedYoutube")} testId="rte-yt">
          <YoutubeLogo size={16} />
        </Btn>
