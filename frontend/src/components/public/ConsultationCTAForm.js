  ...
  return (
    ...
    >
      <div className="max-w-[1920px] mx-auto px-6 lg:px-[100px] text-center">
        ...
        <h3 className="text-[48px] md:text-[80px] font-bold text-white leading-tight mb-16">
          Free consultation
        </h3>
        <form
          onSubmit={submit}
          className="max-w-[372px] mx-auto text-left"
        ...
        >
          ...
          <Field label="Desired Car">
            <input
              ...
              onChange={set("desiredCar")}
              data-testid="consultation-car"
            />
          </Field>
          <Field label="Your Budget*">
            <input
              ...
              value={form.budget}
              onChange={set("budget")}
              data-testid="consultation-budget"
              required
            />
          </Field>
          <Field label="Additional Wishes">
            <textarea
              className="input-dark"
              style={{ height: 90, padding: "12px 16px" }}
              placeholder="Write additional wishes"
              value={form.wishes}
              onChange={set("wishes")}
              data-testid="consultation-wishes"
            />
          </Field>
          <button
            type="submit"
